...
| --------- | ------ | ----- | ----- | ------------- | ------ |
|  @id | ID | 1..1 | 1..1 | Unique identifier for the Line (e.g., NP:Line:5) | Line/@id  |
|  @version | String | 1..1 | 1..1 | Version label | Line/@version  |
|  Name | String | 1..1 | 1..1 | Human-readable line name | Line/Name  |
|  TransportMode | Enum | 0..1 | 1..1 | Primary transport mode (bus, rail, water, tram, metro, air, coach, telecabin) | Line/TransportMode  |
...
|  [Operator](../Operator/Table_Operator.md)@ref | Reference | 0..1 | 1..1 | Reference to the Operator running this Line | Line/OperatorRef/@ref  |
