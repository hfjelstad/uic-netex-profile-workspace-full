...
| --------- | ------ | ----- | ----- | ------------- | ------ |
|  @id | ID | 1..1 | 1..1 | Unique identifier for the ticketing equipment | TicketingEquipment/@id  |
|  @version | String | 1..1 | 1..1 | Version number for change tracking | TicketingEquipment/@version  |
